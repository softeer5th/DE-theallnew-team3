...
def lambda_handler(event, context):
    ...
    READ_OBJECT_KEY = f"{car_name}/{year}/{month}/{day}/target/bobae_failed.csv"
    FAILED_OBJECT_KEY = (
        f"{car_name}/{year}/{month}/{day}/target/bobae_failed_failed.csv"
    )
    WRITE_OBJECT_KEY = f"{car_name}/{year}/{month}/{day}/raw/bobae_recovery.json"
